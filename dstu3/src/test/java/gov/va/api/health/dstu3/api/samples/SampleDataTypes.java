...
import gov.va.api.health.dstu3.api.bundle.AbstractEntry;
import gov.va.api.health.dstu3.api.datatypes.Address;
import gov.va.api.health.dstu3.api.datatypes.Address.AddressType;
import gov.va.api.health.dstu3.api.datatypes.Address.AddressUse;
import gov.va.api.health.dstu3.api.datatypes.Annotation;
import gov.va.api.health.dstu3.api.datatypes.Attachment;
import gov.va.api.health.dstu3.api.datatypes.CodeableConcept;
import gov.va.api.health.dstu3.api.datatypes.Coding;
import gov.va.api.health.dstu3.api.datatypes.ContactPoint;
import gov.va.api.health.dstu3.api.datatypes.ContactPoint.ContactPointSystem;
import gov.va.api.health.dstu3.api.datatypes.ContactPoint.ContactPointUse;
import gov.va.api.health.dstu3.api.datatypes.Duration;
import gov.va.api.health.dstu3.api.datatypes.HumanName;
import gov.va.api.health.dstu3.api.datatypes.HumanName.NameUse;
import gov.va.api.health.dstu3.api.datatypes.Identifier;
import gov.va.api.health.dstu3.api.datatypes.Identifier.IdentifierUse;
import gov.va.api.health.dstu3.api.datatypes.Period;
import gov.va.api.health.dstu3.api.datatypes.Quantity;
import gov.va.api.health.dstu3.api.datatypes.Range;
import gov.va.api.health.dstu3.api.datatypes.Ratio;
import gov.va.api.health.dstu3.api.datatypes.SampledData;
import gov.va.api.health.dstu3.api.datatypes.Signature;
import gov.va.api.health.dstu3.api.datatypes.SimpleQuantity;
import gov.va.api.health.dstu3.api.datatypes.SimpleResource;
import gov.va.api.health.dstu3.api.datatypes.Timing;
import gov.va.api.health.dstu3.api.datatypes.Timing.EventTiming;
import gov.va.api.health.dstu3.api.datatypes.Timing.Repeat;
import gov.va.api.health.dstu3.api.datatypes.Timing.UnitsOfTime;
import gov.va.api.health.dstu3.api.elements.Extension;
import gov.va.api.health.dstu3.api.elements.Meta;
import gov.va.api.health.dstu3.api.elements.Narrative;
import gov.va.api.health.dstu3.api.elements.Narrative.NarrativeStatus;
import gov.va.api.health.dstu3.api.elements.Reference;
import gov.va.api.health.dstu3.api.resources.OperationOutcome.Issue;
import gov.va.api.health.dstu3.api.resources.OperationOutcome.Issue.IssueSeverity;
